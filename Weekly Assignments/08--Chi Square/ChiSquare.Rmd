...
###Chi-Square
We can also run a chi square test, dividing one of the variables into 2 levels. Say, "low internet use" and "high internet use", and test for the probability of our data assuming the null, that there is no relationship.
